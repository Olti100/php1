...
background: linear-gradient(to right, rgba(106, 17, 203, 1), rgba(37, 117, 252, 1))</style>
</head>
<body>
    <form action="">
  <!-- Email input -->
  ...
  <!-- Submit button -->
  <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4" type="submit" name="submit">Log in</button>
